	    				...
	    				<table class="table">
						    <thead class="thead-primary">
						      <tr class="text-center">
						        <th>&nbsp;</th>
						        <th>&nbsp;</th>
						        <th class="bg-primary heading">Self-Driver-Rate</th>
						        <th class="bg-dark heading">With-Driver-Rate</th>
						      </tr>
						    </thead>
						    <tbody>
                  <?php if(!empty($car_lists)){ ?>
                    <?php foreach($car_lists as $car_list){ ?>
                     <tr>
                      ...
                      <td class="car-image">
                        <div class="img"
                          style="background-image:url('images/uploads/<?= $car_list['image']; ?>')">
                        </div>
                      </td>

                      <!-- NAME -->
                      <td class="product-name">
                        <h3><?= $car_list['car_name']; ?></h3>
                        <p class="mb-0 rated">
                          <span>rated:</span>
                      ...
                      <td class="price">
                        <div class="price-rate">
                          <h3>
                            <span class="num">
                              <small class="currency">₹</small><?= $car_list['self_drive_price']; ?>
                            </span>
                            <span class="per">/ Self-Drive</span>
                          </h3>
                        </div>
                      </td>
                      ...
                      <td class="price">
                        <div class="price-rate">
                          <h3>
                            <span class="num">
                              <small class="currency">₹</small><?= $car_list['with_driver_price']; ?>
                            </span>
                            <span class="per">/ With-Driver</span>
                          </h3>
                        </div>
                      </td>
