      ...
      <div class="container">
        <div class="row d-flex mb-5 contact-info">
        		...
        		<div class="row mb-5">
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Address:</span>Office No. 203, Business Hub, Jaipur, Rajasthan, India</p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Phone:</span> <a href="tel://1234567920">91+ 987 232 3482</a></p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
          ...
          <div class="col-md-8 block-9 mb-md-5">
            <form action="includes/Contacts.php" method="post" class="bg-light p-5 contact-form">
