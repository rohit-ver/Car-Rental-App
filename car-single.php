...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/car-single.jpg');" data-stellar-background-ratio="0.5">
	...
	<div class="container">
		...
		<?php foreach($car_lists as $car_list){ ?>
			...
			<div class="car-wrap rounded ftco-animate">
				...
				style="background-image: url('images/uploads/<?= htmlspecialchars($car_list['image']); ?>');
						height:250px;
				...
				<div class="text">
				<h2 class="mb-0">
					<a href="car-single.php?id=<?= $car_list['id']; ?>">
					<?= htmlspecialchars($car_list['car_name']); ?>
					</a>
				</h2>

				<div class="d-flex mb-3">
					<span class="cat"><?= htmlspecialchars($car_list['brand']); ?></span>
					<p class="price ml-auto">
					₹<?= htmlspecialchars($car_list['price_per_day']); ?> <span>/day</span>
					</p>
				</div>

				<p class="d-flex mb-0 d-block">
					<a href="Book_car.php?car_id=<?= $car_list['id']; ?>" class="btn btn-primary py-2 mr-1">
					Book now
					</a>
					<a href="car-single.php?id=<?= $car_list['id']; ?>" class="btn btn-secondary py-2 ml-1">
					Details
					</a>
				</p>
				</div>
